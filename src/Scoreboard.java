public class Scoreboard {
    public void scoreboard(Teams team1, Teams team2){
        ...
        if(team1.getScore() > team2.getScore()){
            System.out.println(team1.getName() + " won the match by " + (10-team1.getWickets()) + " wickets.");
        }
        else if(team1.getScore() == team2.getScore()){
            System.out.println("Equal Scores!! Match Tie.");
        }
        else {
            System.out.println(team2.getName()+ " won the match by " + (10-team2.getWickets()) + " wickets.");
        }
    }
}
